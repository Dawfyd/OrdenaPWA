        ...
        <div>
          <Link to={'/restaurant/tables_admin'}>
            <button className='button_tables' id="B1">
              <img src ={currentRoute === '/restaurant/tables_admin' ? icon_tables_active : icon_tables}
        ...
        <div>
          <Link to={'/restaurant/info_table_admin'}>
            <button className='button_info_table' id="B2">
              <img src={currentRoute === '/restaurant/info_table_admin' ? icon_info_table_active : icon_info_table}
        ...
        <div>
          <Link to={'/restaurant/code_qr_admin'}>
            <button className='button_code_qr' id="B4">
              <img src ={currentRoute === '/restaurant/code_qr_admin' ? icon_code_qr_active : icon_code_qr}
        ...
        <div>
          <Link to={'/restaurant/account_admin'}>
            <button className='button_account_service' id="B5">
              <img src ={currentRoute === '/restaurant/account_admin' ? icon_account_service_active : icon_account_service}
