          ...
          <li>
            <form className = 'navbar'>
                <select className="num">
                  ...
                  <option className = 'num_1' value="1">1</option>
                  <option className = 'num_2' value="2">2</option>
                  <option className = 'num_3' value="3">3</option>
                  <option className = 'num_4' value="4">4</option>
                  <option className = 'num_5' value="5">5</option>
                </select>
            </form>
          </li>
        </ul>
