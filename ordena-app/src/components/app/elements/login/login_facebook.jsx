...
return (
  <div>
    ...
    render={renderProps => (
    <div>
    <img onClick={renderProps.onClick} src={TextFacebook} className="text_facebook" alt="logo" />
    <img onClick={renderProps.onClick} src={IconFacebook} className="icon_facebook" alt="logo" />
    </div>
  )}
    />
