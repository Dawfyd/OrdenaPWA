...
function CashierRegister({data_tables,data_order,data_user,data_products,order_ready,select_table,display_button,order_check}) {
    return (
        ...
        <div className= 'cashier_register_order' key={o.id}>
            ...
            data_user.filter(c => c.id === o.id_user)
                ...
                data_products.filter(e => e.id_order === o.id)
                    ...
                    <div className='cashier_register_products' key={p.id}>
                        ...
                        <img src ={check}
                             ...
                             alt="icon_home"
                             style={p.state_check === true ? {display: 'block'} :
                                                             {display: 'none'}}/>
                        </button>

                        <div className = 'container_flex'>
                        <p className ='cashier_item'>{p.unit_item} ud - {p.product}</p>
                        <p className ='cashier_user'>{j.name}</p>
                        <p className ='cashier_price'>${formatNumber(p.price_item)}</p>
                        </div>
                   </div>
                  ))
                  }
